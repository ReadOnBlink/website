...
backToNewsBtn.addEventListener('click', () => {
    ...
    document.querySelector('#ai-info-text').innerText = '';
    document.querySelector('#ai-info-card').style.display = 'none';
    document.querySelector('#openai-info-btn').style.display = 'block';
...
searchBtn.addEventListener('click', async e => {
    ...
    console.log('Query: ', searchbar.value.trim());
    ...
    await searchNews(GNewsAPIKey, searchbar.value.trim());
...
mobileSearchBtn.addEventListener('click', async e => {
    ...
    console.log('Query: ', mobileSearchbar.value.trim());
    ...
    await searchNews(GNewsAPIKey, mobileSearchbar.value.trim());
...
const aiInfoBtn = document.querySelector('#ai-info-card .bottom-bar span');
aiInfoBtn.addEventListener('click', () => {
    alert('The content that was just shown was generated by an AI model. Please verify the validity of the facts since inaccuracies can be present.');
});